<script>
  ...
  let logoPt1Visible = false;
  let logoPt2Visible = false;
  onMount(() => {
    logoPt1Visible = true;
    setTimeout(() => (logoPt1Visible = false), 1500);
    setTimeout(() => (logoPt2Visible = true), 1200);
  });
</script>
...
<header>
  <div class="composite-icon">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 166.09 113.65">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 263.5 182">
      {#if logoPt1Visible}
        <polyline
          in:draw={{ duration: 1500 }}
          out:fade
          points="79 39.5 79 3.5 2 90.5 79 178.5 78.5 140 36.5 91 111.5 2 111.5
          66 113.5 2 221.5 2 261.5 147 261.5 178 248.5 178 259.5 143 253.5 125
          238.5 178 227.5 178 247.5 105 242.5 84 218.5 171 212.5 147 237.5 65
          231.5 45 207.5 131 201.5 110 225.5 28 220.5 7 195.5 99 219.5 176 225.5
          178 218.5 178 172.5 179 193.5 101 171.5 179 131.5 179 131.5 144 170.5
          3 131.5 3 131.5 180 81.5 179 81.5 141 113.5 178 112.5 90 89.5 90"
          fill="none"
          stroke="var(--link)"
...
{:then projects}
  ...
  <p style="text-align: center; opacity: 0.2; margin-top: -100px;">
    More coming soon
  </p>
{:catch error}
  <p>Error while loading</p>
